...
<img src="docs/images/screenshot_search.png" width="600" alt="検索画面">
...
| 入力欄 | 説明 | 自動入力 |
|---|---|---|
| note表記 | noteに表記されている言葉 | ✅ 検索語が入る |
| 原稿表記 | 原稿に記載されている言葉 | 手動入力 |
| 備考 | 使い分けのルールなど | 手動入力 |
...
<img src="docs/images/screenshot_memo.png" width="600" alt="校正メモ入力画面">
